...
const QrReader = ({ setIsScanner, setResScaner }) => {
    ...
    return (
        <Box position={"relative"} bgColor={"black"}>
            <div ref={scannerRef} id="qr-reader" style={{ position: "relative", backgroundColor: "black" }} />
            <IoClose
                onClick={() => setIsScanner(false)}
                color="white" style={{ position: "absolute", top: "10px", right: "10px", cursor: "pointer", zIndex: "99" }}
                size={32} />
        </Box>
